...
As seen in Figure \ref{dual-learning}, after the $ReLU$ layers we have $H_i^m$ and $H_i^s$ for the method-level and the statement-level. By putting them all into the cross-stitch unit, we have:
