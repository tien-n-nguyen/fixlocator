...
(1) {\bf Hit-N} measures the percentage of bugs that the predicted set
contains {\em at least} $N$ faulty statements (i.e., the predicted set
and the correct set overlap at least $N$ statements).

(2) {\bf Hit-All} is the percentage of bugs in which the predicted set exactly
...
(3) {\bf Hit-N@Top-$K$} is the percentage that the list of the top-$K$
...
output of \code{methFL} to the input of \code{stmtFL}.
