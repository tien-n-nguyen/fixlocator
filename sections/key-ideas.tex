...
to locate all the fixing locations (i.e., statements) that need to be
modified in a fix for a given bug. {\tool} has the following novel
key ideas in both new model and features:
...
interdependent. There are several dependencies among them. Thus, we
