...
1) {\em \underline{The method's content}}: the method's content is a
sequence of the sub-tokene of the program elements found in the
method's interface and body. To capture the meaning of each sub-token
in that sequence, we use a word embedding model, called
GloVe~\cite{glove2014} 
