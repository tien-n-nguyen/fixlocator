...
4) {\em Similarity}: we also extract the similar methods in the
project that have been buggy before in the project history. We keep
only the most similar method for each method.
...
of names and types, e.g., {\em ``price int name String ..."}.  Second,
