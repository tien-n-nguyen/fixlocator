...
DEAR~\cite{icse22} by 16.6\%, 16.9\%, 9.9\%, and {\bf 20.6\%}
...
%respectively.
{\tool} also improves over those baselines by {\bf 32.0\%}, {\bf
...
%
To evaluate its usefulness in APR, we used it in combination with the
APR tools, DEAR~\cite{icse22} and CURE~\cite{cure-icse21} in which we
replaced their FL modules with our tool. Our result shows that
{\tool}+DEAR and {\tool}+CURE improve relatively over the original
DEAR and CURE {\bf 10.5\%} and {\bf 42.9\%} in the numbers of fixed
bugs.
