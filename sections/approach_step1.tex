...
case as we ran it. Because the stack trace can be very long, from
the failing/crash point, we collect only part of the stack trace with
$n$ levels of depth from that point. From a previous
work~\cite{sungkim-issta}, in our experiment, we use $n$=10. In
...
point. In our experiment, we use $n$=10.
