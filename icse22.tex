...
method-level FL model, \code{MethFL}, learns the methods to be
fixed together. Second, the statement-level FL
...
baselines by locating more buggy statements from 26.5\% to 155.6\%, and reduces the statements to be
examined by 22\%--30\% in terms of EXAM score.
\end{abstract}
