...
program dependencies among statements. Our empirical evaluation on
...
fixing statements from {\bf 26.5\% to 155.6\%}.
%and reduces the statements to be examined by {\bf 22\%--30\%}.
%
...
of the numbers of bug fixes in comparison with DEAR's original CC fixing location module.
\end{abstract}
