...
%To evaluate {\tool}'s usefulness,
We replaced the original CC fixing-location module in
DEAR~\cite{icse22} with {\tool} to build a variant of DEAR, namely DEAR$^*$. 
We also added~our tool to
CURE~\cite{cure-icse21} as CURE$^*$ (\tool + CURE).
 We compared the variants with the
original~ones
