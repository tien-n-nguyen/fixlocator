...
APR tools, DEAR and CURE in which we replaced their FL modules with
our tool. The result shows that {\tool}+DEAR and {\tool}+CURE 
improve relatively over the original DEAR and CURE 10.5\% and 42.9\%
in the numbers of fixed bugs.
\end{abstract}
