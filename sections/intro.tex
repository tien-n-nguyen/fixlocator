...
We propose {\tool}, a fault localization approach for faulty
...
\code{MethFL} and \code{StmtFL} is modeled by the learning a linear
combination of the input features from two models. The cross-stitch
units enable the propagation of the impact of \code{MethFL} on
