...
%
The sizes of our predicted sets range from {\bf XX} to {\bf XX} with a
median size of {\bf XX}. Thus, {\tool} detects well for the common
cases in terms of the number of buggy statements, while it is still
challenging for all models for the cases of more than 5 buggy
statements.
