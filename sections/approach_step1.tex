...
3) {\em \underline{Most similar buggy method}}: we keep the most
  ...
  (represented by the GloVe embeddings~\cite{glove2014}) measured by the cosine similarity.  For $M_b$,
...
FL, we integrate them into the feature graph. In
...
connects to the ones at lines 7--8, and to the ones at lines
10--11.
